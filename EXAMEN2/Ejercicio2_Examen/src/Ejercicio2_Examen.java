...
public class Ejercicio2_Examen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("==================");
        System.out.print("Introduce código de libro: ");//Aqui le pido el cod del libro al usuario y me lo guardo en la variable codigoLibro
        int codigoLibro= s.nextInt();
        System.out.print("Introduce precio: ");//Aqui hago lo mismo pero con el precio y lo guardo en la variable precioLibro
        ...
        double precioCantidad= precioLibro*unidadesVendidas;//Aqui calculo precio de la cantidad de libro comprados y lo guardo en la variable precioCantidad
        double descuentoLibro= precioCantidad*descuento/100;//Aqui calculo el descuento de la cantidad de precioCantidad y lo guardo en descuentoLibro
        double precioCantidadDescontada= precioCantidad-descuentoLibro;//Aqui calculo el precio de los libros con el descuento
        ...
        System.out.println("");//Apartir de aqui voy creando la facturilla con paciencia y rellenando cada apartado con su valor y con el %x.xd,f o s para guardar espacios a ese numero  
