            ...
            <div class="panel panel-info">
                ...
                <form method="get" action="grabaSocioModificado.jsp">
                    ...
                    <div class="form-group"> 
                        <label>&nbsp;&nbsp;Nº de socio:&nbsp;</label><input type="text" size="5" name="socioID" value="<%= Integer.parseInt(request.getParameter("socioID")) %>" readonly>
                    </div>
                    <div class="form-group">
                        <label>&nbsp;&nbsp;Nombre:&nbsp;</label><input type="text" size="35" name="nombre" value="<%= request.getParameter("nombre") %>">
                    </div>
                    <div class="form-group">
                        <label>&nbsp;&nbsp;Estatura (en cm):&nbsp;</label><input type="text" size="5" name="estatura" value="<%= Integer.parseInt(request.getParameter("estatura")) %>">
                        <label>&nbsp;&nbsp;Edad:&nbsp;</label><input type="text" size="5" name="edad" value="<%= Integer.parseInt(request.getParameter("edad")) %>">
                    </div>
                    <div class="form-group">
