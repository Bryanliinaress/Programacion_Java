...
public class CadenasTexto {
     ...
     * @return esperamos que frase1 y frase2 sean iguales estando una invertida
     *         respecto a la otra
     */
    ...
    public static void main(String[] args) {
        ...
        numero = s.nextInt();
        int numeroInvertido = Ejercicio1_14.voltearNumeros(numero);
        int numeroEnSigular = numeroInvertido % 10;;
        while (numeroInvertido > 10) {
            numeroInvertido = numeroInvertido / 10;
            for (int i = 1; i <= numeroEnSigular; i++) {
                System.out.print("|");
            }
            System.out.print(" - ");
            numeroEnSigular = numeroInvertido % 10;
        }
            for (int i = 1; i <= numeroEnSigular; i++) {
                System.out.print("|");
            }
